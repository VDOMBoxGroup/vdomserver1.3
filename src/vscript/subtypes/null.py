...
null.and_table={
	...
	double: lambda self, another: v_null if float(another) else integer(0),
	date: lambda self, another: v_null if float(another) else integer(0),
	string: lambda self, another: v_null if float(another) else integer(0),
...
null.or_table={
	...
	double: lambda self, another: integer(int(float(another))) if int(float(another)) else v_null,
	date: lambda self, another: integer(int(float(another))) if int(float(another)) else v_null,
	string: lambda self, another: integer(int(float(another))) if int(float(another)) else v_null,
...
null.xor_table={
	...
	double: lambda self, another: v_null,
	date: lambda self, another: v_null,
	string: lambda self, another: v_null if float(another) else v_null,
	boolean: lambda self, another: v_null}
