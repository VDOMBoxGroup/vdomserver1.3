...
<div id="Imgload" style="position:absolute; z-index:100; top:0px; left:0px; width:100%; height:100%; background-color:#FFFFFF; display:none" align="center"><br><br><img src="/images/loading.gif" border="0"></div>""")
        ...
        request.write("""
<form method=post action="/restore.py" onsubmit="LoadImgWait();" enctype="multipart/form-data">
...
<div class="wrapper"> 
 ...
 <div class="block">
  ...
  <div class="submit-gray"><input type="submit" value="Restore application"/></div>
